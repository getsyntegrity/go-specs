...
// cite that document as "contract v1.2.7 §N" — sections are amended in place, so a bare section
...
//     `go test -coverprofile` file straight to the finalizer (contract v1.2.7 §9).
