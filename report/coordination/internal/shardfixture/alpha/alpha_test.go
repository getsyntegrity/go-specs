...
const importPath = "github.com/getsyntegrity/go-specs/report/coordination/internal/shardfixture/alpha"
...
func TestAlpha(t *testing.T) {
	specs.DescribeWithReporter(t, "alpha", reporter, func(s *specs.Spec) {
